...
import com.jinkyumpark.user.appUser.dto.*;
import com.jinkyumpark.user.loginUser.LoginUser;
import com.jinkyumpark.user.loginUser.User;
import com.jinkyumpark.user.utils.email.EmailSender;
import com.jinkyumpark.user.utils.email.Mail;
...
public class AppUserControllerV1 {
    ...
    public ResponseEntity<String> changePasswordVerification(@LoginUser User loginUser) {
        String loginUserEmail = loginUser.getName();
        Integer verificationCode = appUserService.getVerificationCode(VERIFICATION_CODE_LENGTH);
        ...
        appUserService.updateUserById(loginUser.getId(), appUserDto);
...
//        appUserService.updateUser(appUserDto);
    ...
    public ResponseEntity<String> changeName(@RequestBody @Valid ChangeNameRequest changeNameRequest, @LoginUser User loginUser) {
