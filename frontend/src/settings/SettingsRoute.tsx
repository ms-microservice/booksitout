...
import { BsGearFill as SettingsIcon} from 'react-icons/bs'

const SettingsRoute = () => {
	return (
		<div className='container-xl'>
			<div className='row row-eq-height justify-content-start'>
				<RouteTitle icon={<SettingsIcon />} title={'설정'} />
				...
				<div className='col-12 col-md-6 mb-1 mb-md-2'>
					<SettingsLinkCard title='커뮤니티 설정' contentList={['커뮤니티 프로필 설정', '알림 설정']} link='/settings/community' />
				</div>
			</div>
		</div>
	)
