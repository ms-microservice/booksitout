	...
	const features = [
		{
			...
			description: [
				...
				'책을 다 읽으면 <b class="text-book">별점</b>을 매기고, <b class="text-book">감상</b>을 쓸 수 있어요',
		...
		},
		{
			...
			description: ['1년 동안의 독서활동을 기반으로 매년 총 독서시간, 하루 평균 독서기간 등을 보여줘요'],
		},
		{
			title: '검색',
		...
		},
		{
			...
			description: [
				...
				'구립도서관, 공립도서관, 서울교육청도서관... <br/>헷갈리는 다양한 도서관에 대한 정보를 쉽게 알려줘요',
			],
		},
		{
			title: '읽고 싶은 책 알림받기',
